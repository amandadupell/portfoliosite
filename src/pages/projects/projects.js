        ...
        return (
            <>
                <PageContainer>
                    ...
                    <GrindTile variant={'project'} image1={Grind} image2={GrindBox} imgH={250} imgW={250} xOffset={32} yOffset={-15} title={'The Grind'} description={DESC.GRIND} skills={SKILLS.GRIND} />
